...
namespace eCommerce.Infra.Migrations
{
    ...
    [Migration("20241021155340_SeedDB1")]
            ...
            modelBuilder.Entity("eCommerce.Domain.Entites.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 10, 21, 15, 53, 39, 659, DateTimeKind.Unspecified).AddTicks(1014), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Moda"
                        },
                        new
                        {
                            Id = 2L,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 10, 21, 15, 53, 39, 659, DateTimeKind.Unspecified).AddTicks(1027), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Informática"
                        },
                        new
                        {
                        ...
                        {
                            Id = 4L,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 10, 21, 15, 53, 39, 659, DateTimeKind.Unspecified).AddTicks(1028), new TimeSpan(0, 0, 0, 0, 0)),
                            Name = "Automóveis"
                        });
                });
            ...
            modelBuilder.Entity("eCommerce.Domain.Entites.User", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreatedDate = new DateTimeOffset(new DateTime(2024, 10, 21, 15, 53, 39, 659, DateTimeKind.Unspecified).AddTicks(3722), new TimeSpan(0, 0, 0, 0, 0)),
